...
public class As2_ArrayPractice {
	...
	public static void main(String[] args) {
		...
		String studentData[][][] = { { // sem1
				{ "Mathematics 1", "Physics", "Chemistry", "Computer Programming", "Engineering Drawing",
						"Basic Electrical Eng" },
				{ "pass(78)", "pass(85)", "Fail(21)", "pass(74)", "pass(88)", "pass(79)" } },

				{ // sem2
						{ "Mathematics II", "Mechanics", "Environmental", "Basic Electronics", "Engineering Physics",
